...
class CreateClientSubscriptionTasksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('client_subscription_tasks', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('client_subscription_tasks');
    }
}
