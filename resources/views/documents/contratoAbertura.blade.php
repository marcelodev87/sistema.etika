...
@section('content')
    <div class="row">
        <div class="col-md-4 col-lg-3">
            <div class="chart-box">
                <form method="post" action="{!! route('app.documents.contratoAbertura') !!}">
                    @csrf
                    ...
                    <fieldset class="form-group form-group-sm">
                        <select class="form-control selectpicker" name="servico_id" required>
                            <option value="">Selecione o Serviço</option>
                            <option value="1" {{ ($request->has('servico_id') && $request->servico_id == 1) ? 'selected' : '' }}>Serviço 1</option>
                            <option value="2" {{ ($request->has('servico_id') && $request->servico_id == 2) ? 'selected' : '' }}>Serviço 2</option>
                        </select>
                    </fieldset>
            ...
            @php
                ...
                switch($request->servico_id){
                    case "2":
                        ...
                        $clausula_primeira .= "<p><strong>a)</strong> Elaboração de Estatuto Social e Ata de Fundação de uma Organização Religiosa (Igreja Evangélica) de acordo com informações fornecidas pelo CONTRATANTE. </p>";
                        $clausula_primeira .= "<p><strong>b)</strong> Elaboração de pedido de CNPJ.</p>";
                    ...
                    case "1":
                        ...
                        $clausula_primeira .= "<p><strong>a)</strong> Elaboração e registro de Estatuto Social e Ata de Fundação de uma Organização Religiosa (Igreja Evangélica) de acordo com informações fornecidas pelo CONTRATANTE.</p>";
                        $clausula_primeira .= "<p><strong>b)</strong> Elaboração e protocolo de pedido de CNPJ.</p>";
                ...
                $valor_extenso = "VALOR EXTENSO DO SERVIÇO";
                $data = date('d/m/Y');
                ...
                if(count($post) == 1){
                    ...
                    $endereco_presidente = $post[1]->addresses()->first()['street'];
                    $complemento_presidente = $post[1]->addresses()->first()['complement'];
                    $bairro_presidente = $post[1]->addresses()->first()['neighborhood'];
                    $cidade_presidente = $post[1]->addresses()->first()['city'];
                    $UF_presidente = $post[1]->addresses()->first()['state'];
                    $CEP_presidente = $post[1]->addresses()->first()['zip'];
