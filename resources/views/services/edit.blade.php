...
@section('header')
    ...
    <li class="active">
        <i class="fa fa-edit"></i> {{ $service->id }}
    </li>
    @endbreadcrumb
@endsection
@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-4">
            <div class="chart-box">
                <form method="post" action="{{ route('app.services.update', $service->id) }}" id="updateForm">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                        <label>Valor</label>
                        <input type="text" class="form-control" name="valor" data-mask="000.000,00" data-mask-reverse="true" value="{{ brl($service->valor, false) }}">
                    </div>

                    <div class="form-group">
                        <label>Valor por extenso</label>
                        <input type="text" class="form-control" name="valorString" value="{{ $service->valor_string }}">
                    </div>
